// 20mm POISON-OAK coin — BEAD v3 "STEM-IN" NO-VEINS variant (jes 2026-07-15)
//
...
//
// NO VEINS: every interior vein stroke removed — the leaflets are plain
// raised silhouettes. Back drawing = leaf OUTLINE + border groove only
// (mirrored + rotated -9.22deg). Deep relief kept: leaf plateau +0.60,
// border +0.80 (to the rim), back drawing 0.60 deep; the front top surface
// is completely uninterrupted (the most slicer-proof variant). Hole as the
// L3b revision: O3.0, top edge tangent to the border, zero bite.
// Self-contained: renders coin_20mm_bead_noveins.stl as accepted.
// Heightmaps baked by gen_bead_v3.py from source_leaf.jpg.

diameter = 20;
total_h  = 3.20;                   // DEEP: face 2.40 + border 0.80
hmfile   = "heightmap_20mm_bead_noveins.png";
img      = 160;

back_hm    = "heightmap_back_20mm_bead_noveins.png";
